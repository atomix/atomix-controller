...
var partitionsResource = schema.GroupVersionResource{Group: "k8s.atomix.io", Version: "v1alpha1", Resource: "partitions"}

var partitionsKind = schema.GroupVersionKind{Group: "k8s.atomix.io", Version: "v1alpha1", Kind: "Partition"}
...
func (c *FakePartitions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Partition, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(partitionsResource, c.ns, name, data, subresources...), &v1alpha1.Partition{})
