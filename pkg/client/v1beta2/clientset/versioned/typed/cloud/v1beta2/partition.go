...
type PartitionInterface interface {
	Create(*v1beta2.Partition) (*v1beta2.Partition, error)
	Update(*v1beta2.Partition) (*v1beta2.Partition, error)
	UpdateStatus(*v1beta2.Partition) (*v1beta2.Partition, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta2.Partition, error)
	List(opts v1.ListOptions) (*v1beta2.PartitionList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta2.Partition, err error)
	PartitionExpansion
}
...
func newPartitions(c *CloudV1beta2Client, namespace string) *partitions {
	return &partitions{
		client: c.RESTClient(),
		ns:     namespace,
	}
...
func (c *partitions) Get(name string, options v1.GetOptions) (result *v1beta2.Partition, err error) {
	result = &v1beta2.Partition{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("partitions").
		Name(name).
...
func (c *partitions) List(opts v1.ListOptions) (result *v1beta2.PartitionList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta2.PartitionList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("partitions").
...
func (c *partitions) Create(partition *v1beta2.Partition) (result *v1beta2.Partition, err error) {
	result = &v1beta2.Partition{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("partitions").
...
func (c *partitions) Update(partition *v1beta2.Partition) (result *v1beta2.Partition, err error) {
	result = &v1beta2.Partition{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("partitions").
...
func (c *partitions) UpdateStatus(partition *v1beta2.Partition) (result *v1beta2.Partition, err error) {
	result = &v1beta2.Partition{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("partitions").
...
func (c *partitions) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta2.Partition, err error) {
	result = &v1beta2.Partition{}
