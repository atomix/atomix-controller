...
import (
	...
	scheme "github.com/atomix/kubernetes-controller/pkg/client/v1beta2/clientset/versioned/scheme"
...
type StorageControllerInterface interface {
	Create(*v1beta2.StorageController) (*v1beta2.StorageController, error)
	Update(*v1beta2.StorageController) (*v1beta2.StorageController, error)
	Delete(name string, options *v1.DeleteOptions) error
	DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error
	Get(name string, options v1.GetOptions) (*v1beta2.StorageController, error)
	List(opts v1.ListOptions) (*v1beta2.StorageControllerList, error)
	Watch(opts v1.ListOptions) (watch.Interface, error)
	Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta2.StorageController, err error)
...
func newStorageControllers(c *CloudV1beta2Client, namespace string) *storageControllers {
...
func (c *storageControllers) Get(name string, options v1.GetOptions) (result *v1beta2.StorageController, err error) {
	result = &v1beta2.StorageController{}
	err = c.client.Get().
		Namespace(c.ns).
...
func (c *storageControllers) List(opts v1.ListOptions) (result *v1beta2.StorageControllerList, err error) {
	var timeout time.Duration
	if opts.TimeoutSeconds != nil {
		timeout = time.Duration(*opts.TimeoutSeconds) * time.Second
	}
	result = &v1beta2.StorageControllerList{}
	err = c.client.Get().
		Namespace(c.ns).
		Resource("storagecontrollers").
...
func (c *storageControllers) Create(storageController *v1beta2.StorageController) (result *v1beta2.StorageController, err error) {
	result = &v1beta2.StorageController{}
	err = c.client.Post().
		Namespace(c.ns).
		Resource("storagecontrollers").
...
func (c *storageControllers) Update(storageController *v1beta2.StorageController) (result *v1beta2.StorageController, err error) {
	result = &v1beta2.StorageController{}
	err = c.client.Put().
		Namespace(c.ns).
		Resource("storagecontrollers").
...
func (c *storageControllers) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1beta2.StorageController, err error) {
	result = &v1beta2.StorageController{}
