...
import (
	...
	k8sutil "github.com/atomix/kubernetes-controller/pkg/controller/v1beta2/util/k8s"
...
func Add(mgr manager.Manager) error {
	...
	err = c.Watch(&source.Kind{Type: &v1beta2.Database{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}

	// Watch for changes to secondary resource Clusters and requeue the owner Database
	err = c.Watch(&source.Kind{Type: &v1beta2.Cluster{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &v1beta2.Database{},
	})
	if err != nil {
		return err
	}
...
func (r *Reconciler) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	v1beta2.SetDatabaseDefaults(database)
...
func (r *Reconciler) reconcileStatus(database *v1beta2.Database) error {
	readyClusters := 0
	for i := 1; i <= int(database.Spec.Clusters); i++ {
...
func (r *Reconciler) reconcileCluster(database *v1beta2.Database, id int) error {
	cluster := &v1beta2.Cluster{}
...
func (r *Reconciler) addCluster(database *v1beta2.Database, id int) error {
